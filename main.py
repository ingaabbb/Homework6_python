...
for i in options:
    ...
    guess_number = "".join(map(str, i))

    if guess_number == real_password:
        print("პაროლი სწორია, საცავი გახსნილია")
        break
    else:
        print(f" ჩვენ მიერ {count} მცდელობისას შეყვანილი პაროლი {guess_number} არასწორია.")
        count +=1 
